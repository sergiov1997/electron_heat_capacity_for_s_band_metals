...
COEFFICIENT_SIXTH_DERIVATIVE_M=3693;
...
for I=1:length(TTe_Taylor_quadr)
    ...
    %Ce_Taylor_O_5(I)=Ce_Taylor_O_3(I)+pi*(2*me/h^2)^1.5*(-sqrt(pi)/40)*k_B^2.5*T_00^(-3.5)*COEFFICIENT_SIXTH_DERIVATIVE_M*TTe_Taylor_quadr(I)^5;
